...
export const plexAPIRequestHandler = <ResultType>(handler: (req: express.Request, res: express.Response) => Promise<ResultType>): ((req: express.Request, res: express.Response) => Promise<void>) => {
